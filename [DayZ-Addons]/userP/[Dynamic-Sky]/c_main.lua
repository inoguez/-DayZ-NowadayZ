...
function startDynamicSky()
	...
	shaderTable.skyboxTropos = dxCreateShader ( "[Dynamic-Sky]/fx/shader_dynamicSky2tropos.fx", 2, 0, false, "object" )
	if dynamicSkySettings.stratosBottomStars then shaderTable.skyboxStratos = dxCreateShader ( "[Dynamic-Sky]/fx/shader_dynamicSky2up.fx", 2, 0, false, "object" ) 
	    else shaderTable.skyboxStratos = dxCreateShader ( "[Dynamic-Sky]/fx/shader_dynamicSky2stratos.fx", 2, 0, false, "object" ) end
	if dynamicSkySettings.stratosBottomStars then shaderTable.skyboxBottom = dxCreateShader ( "[Dynamic-Sky]/fx/shader_dynamicSky2down.fx", 3, 0, false, "object" )
		else shaderTable.skyboxBottom = dxCreateShader ( "[Dynamic-Sky]/fx/shader_dynamicSky2bottom.fx", 3, 0, false, "object" ) end
	shaderTable.clear = dxCreateShader ( "[Dynamic-Sky]/fx/shader_clear.fx", 3, 0, false, "world" )
	textureTable.cloud = dxCreateTexture ( "[Dynamic-Sky]/tex/clouds.dds", "dxt5" )
	textureTable.normal = dxCreateTexture ( "[Dynamic-Sky]/tex/clouds_normal.jpg", "dxt5" ) 
	textureTable.skybox = dxCreateTexture ( "[Dynamic-Sky]/tex/skybox.dds", "dxt5" )
	moonPhase = getCurrentMoonPhase()
	textureTable.moon = dxCreateTexture ( "[Dynamic-Sky]/tex/moon/"..toint( 20 - toint( moonPhase * 20 ) )..".png" )
	...
	modelTable.txd = engineLoadTXD( '[Dynamic-Sky]/tex/skybox_model.txd' )
	engineImportTXD( modelTable.txd, dynamicSkySettings.modelID)
	modelTable.dff = engineLoadDFF( '[Dynamic-Sky]/dff/skybox_model.dff', dynamicSkySettings.modelID )
