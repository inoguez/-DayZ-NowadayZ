...
function startCarPaintRefLite()
	...
	paintShader, tec = dxCreateShader("[CarReflect]/fx/car_paint" .. layerString .. ".fx", 2, v.renderDistance, v.isEffectlayered[1], "vehicle")
	...
	glassShader, tec = dxCreateShader("[CarReflect]/fx/car_glass" .. layerString .. ".fx", 2, v.renderDistance, v.isEffectlayered[2], "vehicle")
	shatterShader, tec = dxCreateShader("[CarReflect]/fx/car_glass" .. layerString .. ".fx", 2, v.renderDistance, v.isEffectlayered[2], "vehicle")

	textureVol = dxCreateTexture("[CarReflect]/images/smallnoise3d.dds")
